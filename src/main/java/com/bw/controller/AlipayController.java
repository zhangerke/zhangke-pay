...
import com.bw.utils.LeeJSONResult;
...
public class AlipayController {
	...
	public String goAlipay(String orderId, HttpServletRequest request, HttpServletRequest response) throws Exception {
		...
		//请求
		this.log.info("AlipayConfig.notify_url==="+AlipayConfig.notify_url);
	 ...
	 */
	  ...
	  static ExecutorService recireThreadPoll= Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());
